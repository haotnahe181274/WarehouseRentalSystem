        ...
        <div class="form-actions">
            ...
            <c:if test="${mode == 'view' && loginUser.role == 'Admin'}">
                <a class="btn btn-primary"
                   href="${pageContext.request.contextPath}/user/edit?id=${targetUser.id}">
                    Update
                </a>
            </c:if>

            <!-- MANAGER (không update Staff & Renter) -->
            <c:if test="${mode == 'view' && loginUser.role == 'Manager'
                          && targetUser.role != 'Staff' && targetUser.role != 'Renter'}">
                  <a class="btn btn-primary"
                     href="${pageContext.request.contextPath}/user/edit?id=${targetUser.id}">
                      Update
                  </a>
            ...
            <!-- PROFILE (Staff / Renter / Manager / Admin đều được) -->
            ...
            <a class="btn btn-secondary"
               href="${isProfile ? pageContext.request.contextPath.concat('/profile')
                       : pageContext.request.contextPath.concat('/user/list')}">
                Back
            </a>

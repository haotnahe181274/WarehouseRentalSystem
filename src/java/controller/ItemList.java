...
public class ItemList extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        StorageUnitItemDAO dao = new StorageUnitItemDAO();
        List<StorageUnitItem> list = dao.getItemsByRenter(user.getId());

        request.setAttribute("itemList", list);
        request.getRequestDispatcher("/Rental/itemList.jsp")
